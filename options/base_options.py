...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', default='./datasets/yh',help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--which_model_netG', type=str, default='resnet_9blocks', help='selects model to use for netG unet_128  resnet_9blocks')
        ...
        self.parser.add_argument('--name', type=str, default='CycleGAN_unpaired_identity_0.5', help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--test_seg_output_dir', type=str, default='/home/rtm/scratch/model_outputs/Output_save/2D/CycleGAN_unpaired_identity_0.5', help='save test sege output results')

        self.parser.add_argument('--dataset_mode', type=str, default='yh', help='chooses how datasets are loadfed. [unaligned | aligned | single | yh | yh_seg| yh_test_seg | yh_seg]')
        self.parser.add_argument('--model', type=str, default='cycle_gan',
                                 help='chooses which model to use. cycle_gan, cycle_gan, test , | test_seg  |cycle_seg')

        self.parser.add_argument('--yh_run_model', type=str, default='Test', help='chooses which Test, Train,  TestSeg')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/home/rtm/scratch/model_outputs/checkpoints/2D', help='models are saved here')
