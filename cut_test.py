...
for param_dict in params:
    ...
    # opt.len_dataset = 120
    opt.print_images_with_uncertainty = True
    opt.eval = True
    opt.model_seg = '2d'
    opt.attribute = 'images'
            ...
            for i, data in enumerate(dataset):
                if i == 0:
                    ...
                    if opt.eval:
                        model.eval()
                model.set_zero()
                model.set_input(data, None)  # unpack data from data loader
